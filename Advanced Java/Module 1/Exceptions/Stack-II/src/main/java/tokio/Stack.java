...
public class Stack {
    ...
    public void push(int number) throws StackFullException {
        ...
        else throw new StackFullException("A pilha está cheia. Não podes adicionar mais elementos.");
    }
    ...
    public void pop() throws StackEmptyException {
        ...
        else throw new StackEmptyException("A pilha está vazia. Não podes retirar elementos.");
    }

    public void top() throws StackEmptyException {
        if(!isEmpty()) System.out.println("O valor que está no topo da pilha é: " + stack[top]);
        else throw new StackEmptyException("A pilha está vazia.");
    }
